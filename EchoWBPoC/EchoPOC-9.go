...
func login(c echo.Context) error {
	...
	if username == "susheel" && password == "12345"{
		...
		*/
		...
		//For getting the JWT Token from cookie, we are creating New cookie
...
func main(){
	...
	jwtGroup.Use(middleware.JWTWithConfig(middleware.JWTConfig{
		...
		TokenLookup: "cookie:JWTCookie", //This tells client look for JWT Token in Cookie, you can also specify different header name instead of default header name 'Bearer'
