...
import (
	...
	_ "myapplication/app"
	controllers1 "myapplication/app/controllers"
	tests "myapplication/tests"
...
func Register() {
	...
	revel.RegisterController((*controllers1.Events)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Create",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers1.Orders)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Create",
				Args: []*revel.MethodArg{ 
			...
			&revel.MethodType{
				Name: "GetPaymentId",
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "orderId", Type: reflect.TypeOf((*int)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
			},
